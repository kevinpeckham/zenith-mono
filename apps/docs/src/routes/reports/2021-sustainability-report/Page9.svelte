						...
						.text-richBlack.grid.grid-cols-1.gap-4
							.order-1
								PieChart(
									...
									value!="{ 29 }",
									width!="{ 145 }")
							.text-13.order-0.font-medium 29-percent of 2021 expansion capital allocated towards renewable fuel infrastructure and building renewable diesel hub in Portland
